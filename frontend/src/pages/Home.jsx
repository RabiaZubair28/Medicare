            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias et voluptate impedit sapiente ullam, ab, voluptatibus cumque nulla inventore quod atque corrupti in necessitatibus fugiat, quae laboriosam ducimus iste repellendus!
                </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
            <div className='py-[30px] px-5'>
                ...
                <div className='mt-[30px]'>
                  ...
                  <Link className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none' to='/doctors'>
    ...
    <section>
      <div className='container'>
        <div className='xl:w-[470px] mx-auto'>
          ...
          <p className='text__para text-center'>
            Our health system offers unmatched, expert health care. From the lab to the clinic, our team.
          </p>
          ...
          <div className='xl:w-[670px]'>
              ...
              <ul className='pl-4'>
                <li className='text__para'>
                    1. Schedule the appintment directly.
                </li>
                <li className='text__para'>
          ...
          <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
              ...
              <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-centergap-[6px] lg:gap-3'>
                    ...
                    <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px] lg:py-3 lg:px-[9px]'>
                      <img src={videoIcon} className='w-4 lg:w-6'></img>
                    </span>
                  </div>
                  ...
                  <div className='flex items-center gap-[6px]lg:gap-[10px] mt-2 lg:mt-[18px]'>
                      ...
                      <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor px-2'>
                        Wayne Collins
                      </h4>
                  </div>
              </div>
