          ...
          <div className='grid grid-cols-1 lg:grid-cols-2'>
            ...
            <div className='mb-5 flex items-center gap-3'>
              ...
              <div className='relative w-[130px] h-[50px]'>
                <input
                type="file" name="photo"  onChange={handleFileInputChange} id="customFile" accept=".jpg, .png" className='absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer'>
                </input>
                <label htmlFor='customFile' className='absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px]leading6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer'>
                  Upload Photo
